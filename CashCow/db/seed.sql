...
INSERT INTO servicecalls(id, title, priority, staus, atm_id, technician_id) VALUES
    (1, 'Pipeline Corrosion Sweep', 'CRITICAL', 1,201),
    (2, 'Warehouse Perimeter Patrol', 'LOW',  3, 202);

INSERT INTO diagnostic_logs(servicecall_id, file_url, notes) VALUES
