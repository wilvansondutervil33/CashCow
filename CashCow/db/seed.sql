...
INSERT INTO atms(id, serial_number, model, status, cash_level, branch_id) VALUES
    ...
    (2, 'ATM-1002', 'DN-Series-100D', 'Low-Cash',7600.0, 1),
    (3, 'ATM-2050', 'SelfServ-81', 'Offline', 900.0, 2),
    (4, 'ATM-1003', 'DN-Series-100D', 'Maintenance', 420.0, 2),
    (5, 'ATM-1004', 'DN-Series-100D', 'Operational',180.5,3),
    (6, 'ATM-1005', 'SelfServ-81', 'Offline',7006.0, 3),
    (7, 'ATM-2060', 'SelfServ-81', 'Low-Cash', 919.0, 4),
    (8, 'ATM-1006', 'SelfServ-81', 'Maintenance', 4122.0, 4);
